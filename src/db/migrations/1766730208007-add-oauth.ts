...
export class AddOauth1766730208007 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "auth_providers" ADD CONSTRAINT "FK_eb4fd6d0f3ad537effb4cb7505a" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
